...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/zbd-payments',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the zbd-payments MCP server. You will use Code Mode to help the user perform
