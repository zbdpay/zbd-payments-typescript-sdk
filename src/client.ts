...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['ZBD_PAYMENTS_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['ZBD_PAYMENTS_LOG'] or 'warn' if it isn't set.
   */
...
export class ZbdPayments {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? ZbdPayments.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('ZBD_PAYMENTS_LOG'), "process.env['ZBD_PAYMENTS_LOG']", this) ??
      defaultLogLevel;
    ...
    const customHeadersEnv = readEnv('ZBD_PAYMENTS_CUSTOM_HEADERS');
    if (customHeadersEnv) {
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api.zebedee.io';
  }
  ...
  static ZbdPayments = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static ZbdPaymentsError = Errors.ZbdPaymentsError;
...
export declare namespace ZbdPayments {
  ...
  export {
    InternalTransfer as InternalTransfer,
